...
function setup_testing_input_output {
  ...
  cp -r ${GRADER_ROOT}/my_own_test/${test_folder}/log_input/batch_log.json ${TEST_OUTPUT_PATH}/log_input/batch_log.json
  cp -r ${GRADER_ROOT}/my_own_test/${test_folder}/log_input/stream_log.json ${TEST_OUTPUT_PATH}/log_input/stream_log.json
}

function compare_outputs {
  PROJECT_ANSWER_PATH1=${GRADER_ROOT}/temp/log_output/flagged_purchases.json
  TEST_ANSWER_PATH1=${GRADER_ROOT}/my_own_test/${test_folder}/log_output/flagged_purchases.json
...
function run_all_tests {
  TEST_FOLDERS=$(ls ${GRADER_ROOT}/my_own_test)
